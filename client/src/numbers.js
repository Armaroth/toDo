function splitN(text) {
    let lines = text.split('\n')
    return lines;
}
let lines = splitN(`2xjzgsjzfhzhm1
...
for (let i = 0; i < newLines.length; i++) {
    ...
    //     numbers[i]= newLines[i][j].match((numberPattern))
    // }
    // for (const char of newLines[i]) {

    // }
    numLines = newLines.filter(char => typeof char === 'number')
}
